...
class Auth
{
    ...
    public function processSLO($keepLocalSession = false, $requestId = null, $retrieveParametersFromServer = false, $cbDeleteSession = null, $stay = false)
    {
        $this->_errors = array();
        $this->_lastError = $this->_lastErrorException = null;
        if (isset($_REQUEST['SAMLResponse'])) { //MOODLE
            $logoutResponse = new LogoutResponse($this->_settings, $_REQUEST['SAMLResponse']);   //MOODLE
        ...
        } else if (isset($_REQUEST['SAMLRequest'])) {   //MOODLE
            $logoutRequest = new LogoutRequest($this->_settings, $_REQUEST['SAMLRequest']);  //MOODLE
            ...
            if (!$logoutRequest->isValid($retrieveParametersFromServer)) {
                ...
                if ($this->getSLObinding() === Constants::BINDING_HTTP_POST) {
                ...
                return $this->redirectTo($responseUrl, $parameters, $stay, $postredirect);   //MOODLE
            }
        } else {
            $this->_errors[] = 'invalid_binding';
            throw new Error(
    ...
    public function redirectTo($url = '', $parameters = array(), $stay = false, $post = false) //MOODLE
    {
        ...
        //BEGIN MOODLE
        if ($post) {
            return Utils::postRedirect($url, $parameters, $stay);
        }
        //END MOODLE
    ...
    public function logout($returnTo = null, array $parameters = array(), $nameId = null, $sessionIndex = null, $stay = false, $nameIdFormat = null, $nameIdNameQualifier = null, $nameIdSPNameQualifier = null)
    {
        ...
        return $this->redirectTo($sloUrl, $parameters, $stay, $postredirect);  //MOODLE
    }
     ...
     *
     * @return string A OneLogin\Saml2\Constants binding value
     */
